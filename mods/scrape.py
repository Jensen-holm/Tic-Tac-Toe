...
""" ONlY NEEDED TO RUN THIS CODE ONE TIME AND THEN I HAD THE WORDS """
...
def save_words() -> None:
    ...
    ws: list[str] = [word for word in all_w if 3 <= len(word) <= 7] # this is pretty inefficient, narrows it down to words at least 3 chars long or larger than 7
